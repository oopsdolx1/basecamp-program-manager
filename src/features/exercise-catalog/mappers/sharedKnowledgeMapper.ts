...
export const fromSharedKnowledge = (exercise: SharedExerciseKnowledge): ExerciseCatalogItem => ({
  ...
  category: known(categoryValues, exercise.category, "other"),
  primaryMuscle: known(muscleValues, exercise.primaryMuscle, "other"),
  secondaryMuscles: exercise.secondaryMuscles.map((value) => known(muscleValues, value, "other")),
  equipmentType: mapEquipment(exercise.equipment),
